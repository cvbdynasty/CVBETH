...
import (
	...
	"github.com/cvbdynasty/cvbEth/ethstats"
	"github.com/cvbdynasty/cvbEth/les"
	...
	"github.com/cvbdynasty/cvbEth/p2p/nat"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/cvbdynasty/cvbEth/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
